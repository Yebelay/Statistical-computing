...
2 R as a set of statistical tables

2.1 Examining the distribution of a set of data

2.2 Simulating the Sample Distribution of the Mean

2.3 One and two sample tests
...
- Optional arguments described on the on-line documentation specify the parameters of the particular binomial distribution.
...
- One convenient use of R program is to provide a simple way for statistical tables of just about any probability distribution and also allows for easy plotting of the form of these distributions.
