---
title: |
       <span style="color:pink"> Introduction to R-Part 3 </span>
subtitle: "dplyr base R"
author: |
  Yebelay Berehan 
institute: |
...
xaringanExtra::use_logo(image_url = "img/base_tidyverse.png",   width = "90px",height = "85px")
```
