---
title: |
       <span style="color:pink">Introduction to R-Part 1</span>
       
subtitle: "Overview of R and RStudio"
author: |
   Yebelay Berehan
institute: |
...
xaringanExtra::use_logo(image_url = "img/Rlogo.png",   width = "90px",height = "85px")
```
