---
title:  |
       <span style="color:pink">Introduction to R-Part 2</span>
subtitle: "Data Manipulation"

author: "Yebelay Berehan"
institute: |
           [<span style="color:cyan">yebelay.ma\@gmail.com</span>](yebelay.ma\@gmail.com)
date: '`r Sys.Date()`'
output:
  xaringan::moon_reader:
    css: [xaringan-themer.css,metropolis, metropolis-fonts.css, custom.css]
    nature:
...
xaringanExtra::use_logo(image_url = "img/dplyrVsdatatable.png",   width = "90px",height = "85px")
```
